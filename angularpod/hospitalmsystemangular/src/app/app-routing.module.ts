...
const routes: Routes = [
  ...
  {path:'docsfordepts/:department_id',component:DocfordepsComponent},
  {path:'appointment_form/:doctor_id',component:AppointmentFormComponent},
  {path:'allappointments/:patient_id',component:AllAppointmentsComponent},
  {path:'feedbackform/:appointment_id',component:FeedbackformComponent},
  ...
  {path:'prescriptionform/:appointment_id',component:PrescriptionformComponent},
