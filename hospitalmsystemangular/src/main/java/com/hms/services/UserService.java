...
//	}
	...
	public void updateu(String username, String firstname, String lastname, String password, int doctor_id, Date dob,
			int department_id, String address, String email, String active) {
	...
	public List<Doctor> showAllDocforDep(int department_id) {
		List<Doctor> users = new ArrayList<Doctor>();
		userRep.getUserdoc(department_id).forEach(e -> System.out.println(e));
		for (Doctor user : userRep.getUserdoc(department_id)) {
			users.add(user);
		}
		return users;
	}
