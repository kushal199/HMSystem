...
public interface PatientRepository extends CrudRepository<Patient, Integer> {
	...
	public void update(@Param("username") String username,@Param("name") String name,@Param("password") String password,@Param("patientId")
	int id,@Param("dob") Date dob,@Param("gender") String gender,@Param("address") String address,@Param("aadhaar") String aadhaar
