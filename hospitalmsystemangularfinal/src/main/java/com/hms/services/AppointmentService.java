...
public class AppointmentService {
	...
	public List<Appointment> showAllAppointforPatient(int patient_id) {
		...
		appointmentRepository.getAppointment(patient_id).forEach(e -> System.out.println(e));
		for (Appointment appointment : appointmentRepository.getAppointment(patient_id)) {
